...
CREATE TABLE IF NOT EXISTS produtos (
    ...
    comissao DECIMAL(10,2) NOT NULL DEFAULT 0 COMMENT 'Valor que fica retido com quem administra a loja antes de repassar o restante ao(a) socio(a).',
    imagem VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS pedidos (
    ...
    comissao DECIMAL(10,2) NOT NULL DEFAULT 0 COMMENT 'Copia do valor de comissao do produto no momento do pedido.',
